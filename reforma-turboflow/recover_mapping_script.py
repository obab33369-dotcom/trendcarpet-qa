...
EXPORT_JSON_PATH = r"C:\Users\AndronikLindgren\.gemini\antigravity\scratch\Projects\REFORMA\reforma-turboflow\turboflow_ready_yesterday.json"
CSV_EXPORT_PATH = r"C:\Users\AndronikLindgren\.gemini\antigravity\scratch\Projects\REFORMA\reforma-turboflow\turboflow_ready_yesterday.csv"
FLAT_JSON_EXPORT_PATH = r"C:\Users\AndronikLindgren\.gemini\antigravity\scratch\Projects\REFORMA\reforma-turboflow\turboflow_ready_yesterday_flat.json"
TXT_EXPORT_PATH = r"C:\Users\AndronikLindgren\.gemini\antigravity\scratch\Projects\REFORMA\reforma-turboflow\turboflow_ready_yesterday.txt"
PROMPTS_ONLY_EXPORT_PATH = r"C:\Users\AndronikLindgren\.gemini\antigravity\scratch\Projects\REFORMA\reforma-turboflow\prompts_only_yesterday.txt"
TRACKING_LOG_PATH = r"C:\Users\AndronikLindgren\.gemini\antigravity\scratch\Projects\REFORMA\reforma-turboflow\turboflow_tracking_log_yesterday.csv"
...
def main():
    ...
    for base, keys in grouped_db.items():
        best_key = sorted(keys, key=get_num)[0]
        primary_db[best_key] = db[best_key]
        
        ex_norm = {item for item in exclude_list}
