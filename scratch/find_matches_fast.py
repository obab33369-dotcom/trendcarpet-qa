...
search_dir = r"C:\Users\AndronikLindgren\OneDrive - CaMa Gruppen AB\Pictures\turboflow\ftp_upload_fixstolar_studio_only"
candidate_files = glob.glob(os.path.join(search_dir, "**", "*.jpg"), recursive=True)
...
print(f"\nSearching for exact pixel matches among {len(candidate_files)} files in studio_only:")
