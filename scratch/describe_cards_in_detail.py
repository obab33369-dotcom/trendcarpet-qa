...
def describe_cards(img_path, key):
    ...
    prompt = (
        ...
        "1. Locate the cards next to the black smartphone. "
        "2. For each card, describe the shape of the card, the direction of the card, "
        "and what digit is written on it. "
        "3. Read the digits both ways (standard reading direction and upside-down/flipped). "
        "4. Which reading direction is right-side up? How do you know? "
        "5. What is the correct 3-digit number?"
    )
...
def main():
    ...
    files = ["ECNJ7018.JPG", "CURC8337.JPG", "CEYY6720.JPG", "BPQA5442.JPG", "OBSY6632.JPG"]
