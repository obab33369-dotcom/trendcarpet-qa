...
def describe_cards(img_path, key):
    ...
    prompt = (
        "We are verifying handwritten number cards in this photo next to the black smartphone. "
        "1. Read the digits as they appear right-side up relative to the camera perspective. "
        "2. What is the correct 3-digit number from the camera perspective?"
    )
...
def main():
    ...
    files = [
        "KWHA5687.JPG", "YLBS5372.JPG", 
        "HPEJ9251.JPG", "OMFT5250.JPG", 
        "NTHT9785.JPG", "RXSA5233.JPG", 
        "NSPM3714.JPG", "OTYL1698.JPG"
    ]
